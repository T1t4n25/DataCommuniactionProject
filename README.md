# Welcome to CRC Simulation Algorithm
...
**2.** the **helper.py** file contains some functions that are necessary in the calculations 
but not necessary to the crc implementation like the modular 2 division and XOR.
